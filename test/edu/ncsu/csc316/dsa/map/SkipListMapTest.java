...
public class SkipListMapTest {
	...
	public void testStudentMap() {
		...
		assertEquals("SkipListMap[J,K,1,0,0.0,jk, J,S,2,0,0.0,js]", studentMap.toString());
		studentMap.put(s3,  3);
		assertTrue(studentMap.get(s3).equals(3));
		assertEquals("SkipListMap[S,H,3,0,0.0,sh, J,K,1,0,0.0,jk, J,S,2,0,0.0,js]", studentMap.toString());
		...
		assertEquals("SkipListMap[L,B,5,0,0.0,lb, S,H,3,0,0.0,sh, J,J,4,0,0.0,jj]", studentMap.toString());
